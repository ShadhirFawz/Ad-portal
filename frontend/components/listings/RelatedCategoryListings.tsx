      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="flex h-36 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 gap-4 animate-pulse"
            >
              <div className="w-32 h-full rounded-xl bg-slate-200 dark:bg-slate-800 shrink-0" />
